package com.example.androidstocks;

import java.util.List;

import com.example.androidstocks.stockquotesapp.adapters.QuoteAdapter;
import com.example.androidstocks.stockquotesapp.model.QuotesModel;
import com.example.androidstocks.stockquotesapp.vo.QuoteVO;
import com.example.androidstocks.utils.RestClient;
			...
			public void handleMessage(Message msg) {
				...
				if (messageStr.equals("success")) {
					...
					QuoteAdapter adapter = new QuoteAdapter(MainActivity.this,
							QuotesModel.getInstance().getQuotes());//show List items on success
